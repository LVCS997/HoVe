...
<ul>
    ...
    <li>
        <a href="#" data-content="Tutores" class="menu-item flex items-center p-2 text-gray-700 hover:bg-blue-50 rounded-lg">
            <i class="bi bi-person w-5 h-5 mr-2"></i>
            Tutores
        </a>
    </li>
    <li>
        <a href="#" data-content="Pets" class="menu-item flex items-center p-2 text-gray-700 hover:bg-blue-50 rounded-lg">
